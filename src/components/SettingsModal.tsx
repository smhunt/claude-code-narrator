...
export function SettingsModal({
  ...
  return (
    <>
      ...
      {/* Slide-out Drawer */}
      <div
        className={`fixed top-0 right-0 z-50 h-full w-80 max-w-[85vw] bg-theme-secondary shadow-2xl border-l border-theme transform transition-transform duration-300 ease-in-out ${
